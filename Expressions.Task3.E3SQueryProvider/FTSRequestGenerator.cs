...
namespace Expressions.Task3.E3SQueryProvider
{
    public class FtsRequestGenerator
    {
        ...
        public Uri GenerateRequestUrl(Type type, string query = "*", int start = 0, int limit = 10)
        {
            ...
            string ftsQueryRequestString = JsonConvert.SerializeObject(ftsQueryRequest);

            Uri uri = BindByName($"{_baseAddress}{_FTSSearchTemplate}",
        ...
        {
            object[] attributes = type.GetCustomAttributes(typeof(E3SMetaTypeAttribute), false);
